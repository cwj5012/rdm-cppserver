...
class AddressBook PROTOBUF_FINAL :
 ...
 public:
  ...
  ::Person* mutable_person_info(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Person >*
      mutable_person_info();
  private:
  const ::Person& _internal_person_info(int index) const;
  ::Person* _internal_add_person_info();
  public:
  const ::Person& person_info(int index) const;
  ::Person* add_person_info();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Person > person_info_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_Person_2eproto;
};
// ===================================================================
...
inline ::Person* AddressBook::mutable_person_info(int index) {
  // @@protoc_insertion_point(field_mutable:AddressBook.person_info)
  return person_info_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Person >*
AddressBook::mutable_person_info() {
  // @@protoc_insertion_point(field_mutable_list:AddressBook.person_info)
  return &person_info_;
}
inline const ::Person& AddressBook::_internal_person_info(int index) const {
  return person_info_.Get(index);
}
inline const ::Person& AddressBook::person_info(int index) const {
  // @@protoc_insertion_point(field_get:AddressBook.person_info)
  return _internal_person_info(index);
}
inline ::Person* AddressBook::_internal_add_person_info() {
  return person_info_.Add();
}
inline ::Person* AddressBook::add_person_info() {
  // @@protoc_insertion_point(field_add:AddressBook.person_info)
  return _internal_add_person_info();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Person >&
AddressBook::person_info() const {
  // @@protoc_insertion_point(field_list:AddressBook.person_info)
  return person_info_;
}
