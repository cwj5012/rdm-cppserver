...
#ifndef PROTOBUF_INCLUDED_server_5finfo_2eproto
#define PROTOBUF_INCLUDED_server_5finfo_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_server_5finfo_2eproto
...
namespace protobuf {
template<>
::cce::pb::ServerInfo* Arena::CreateMaybeMessage<::cce::pb::ServerInfo>(Arena*);
template<>
::cce::pb::ServerRegister* Arena::CreateMaybeMessage<::cce::pb::ServerRegister>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace cce {
namespace pb {
...
class ServerInfo
        : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cce.pb.ServerInfo) */ {
public:
    ServerInfo();
    virtual ~ServerInfo();
...
private:
    ...
    friend struct ::protobuf_server_5finfo_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class ServerRegister
        : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cce.pb.ServerRegister) */ {
public:
    ServerRegister();
...
#endif  // PROTOBUF_INCLUDED_server_5finfo_2eproto
