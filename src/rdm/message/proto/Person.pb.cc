...
::google::protobuf::internal::SCCInfo<0> scc_info_Person_PhoneNumber =
        {{ATOMIC_VAR_INIT(
                  ::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsPerson_PhoneNumber},
         {}};
...
void AddDescriptorsImpl() {
    ...
    static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
            ...
            "o\030\001 \003(\0132\007.Personb\006proto3"
    };
...
namespace protobuf {
template<>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::Person_PhoneNumber* Arena::CreateMaybeMessage<::Person_PhoneNumber>(Arena* arena) {
    return Arena::CreateInternal<::Person_PhoneNumber>(arena);
}
template<>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::Person* Arena::CreateMaybeMessage<::Person>(Arena* arena) {
    return Arena::CreateInternal<::Person>(arena);
}
template<>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::AddressBook* Arena::CreateMaybeMessage<::AddressBook>(Arena* arena) {
