...
namespace protobuf_server_5finfo_2eproto {
...
void protobuf_AssignDescriptors() {
    AddDescriptors();
    AssignDescriptors(
            "server_info.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
    ...
    static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
            "\n\021server_info.proto\022\006cce.pb\"&\n\nServerInf"
            "o\022\n\n\002id\030\001 \001(\r\022\014\n\004type\030\002 \001(\r\"*\n\016ServerReg"
            "ister\022\n\n\002id\030\001 \001(\r\022\014\n\004type\030\002 \001(\rb\006proto3"
    };
    ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
            descriptor, 119);
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
            "server_info.proto", &protobuf_RegisterTypes);
}
...
ServerInfo::ServerInfo()
    ...
    ::google::protobuf::internal::InitSCC(
            &protobuf_server_5finfo_2eproto::scc_info_ServerInfo.base);
    SharedCtor();
...
const ::google::protobuf::Descriptor* ServerInfo::descriptor() {
    ::protobuf_server_5finfo_2eproto::protobuf_AssignDescriptorsOnce();
    return ::protobuf_server_5finfo_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ServerInfo& ServerInfo::default_instance() {
    ::google::protobuf::internal::InitSCC(&protobuf_server_5finfo_2eproto::scc_info_ServerInfo.base);
...
::google::protobuf::Metadata ServerInfo::GetMetadata() const {
    protobuf_server_5finfo_2eproto::protobuf_AssignDescriptorsOnce();
    return ::protobuf_server_5finfo_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
ServerRegister::ServerRegister()
        : ::google::protobuf::Message(), _internal_metadata_(NULL) {
    ::google::protobuf::internal::InitSCC(
            &protobuf_server_5finfo_2eproto::scc_info_ServerRegister.base);
    SharedCtor();
...
const ServerRegister& ServerRegister::default_instance() {
    ::google::protobuf::internal::InitSCC(&protobuf_server_5finfo_2eproto::scc_info_ServerRegister.base);
    return *internal_default_instance();
}
...
namespace protobuf {
template<>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cce::pb::ServerInfo*
Arena::CreateMaybeMessage<::cce::pb::ServerInfo>(Arena* arena) {
    return Arena::CreateInternal<::cce::pb::ServerInfo>(arena);
}
template<>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cce::pb::ServerRegister*
Arena::CreateMaybeMessage<::cce::pb::ServerRegister>(Arena* arena) {
